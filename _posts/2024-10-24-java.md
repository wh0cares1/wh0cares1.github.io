...
- Add intermediate classes to link the entry point to the malicious sinkhole.
...
**Internal Mechanics**
- An effective exploit combines *trampolines* to bridge the deserialization process with *sinkholes* that execute malicious payloads.
- *Trampoline*: `HashSet.readObject()` → Invokes `hashCode()` or `compareTo()` on malicious objects.
- *Bridge*: The malicious object uses `Reflection` to call methods dynamically.
...
- *Sinkhole*: Invokes `Runtime.getRuntime().exec()` for command execution.
...
- [FreeMarker](https://dem0dem0.top/2023/10/20/freemarker%E5%88%9D%E6%8E%A2/)

[Thymeleaf](https://www.thymeleaf.org/)
- [Exploiting SSTI in Thymeleaf](https://www.acunetix.com/blog/web-security-zone/exploiting-ssti-in-thymeleaf/)
- [Thymeleaf Adventure](https://dem0dem0.top/2023/10/20/thymeleaf%E6%8E%A2%E9%99%A9/)
