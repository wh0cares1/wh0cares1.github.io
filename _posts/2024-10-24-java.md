...
- Readmore:
	...
	- [RMIScout: Safely and Quickly Brute-Force Java RMI Interfaces for Code Execution](https://bishopfox.com/blog/rmiscout)
	- [Lessons Learned on Brute-forcing RMI-IIOP With RMIScout](https://bishopfox.com/blog/brute-forcing-rmi-iiop-with-rmiscout)
...
- [Attacking Unmarshallers :: JNDI Injection using Getter Based Deserialization Gadgets](https://srcincite.io/blog/2019/08/07/attacking-unmarshallers-jndi-injection-using-getter-based-deserialization.html)
- [From Serialized to Shell :: Exploiting Google Web Toolkit with EL Injection](https://srcincite.io/blog/2017/05/22/from-serialized-to-shell-auditing-google-web-toolkit-with-el-injection.html)
