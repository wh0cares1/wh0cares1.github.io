...
## PHP Configs
The configuration file [php.ini](https://www.php.net/manual/en/configuration.file.php) is located. It is useful for exploitation.
...
**Security Best Practice**: Disable `allow_url_fopen` and `allow_url_include` in `php.ini` to mitigate remote file inclusion risks. Readmore: [Supported Protocols and Wrappers](https://www.php.net/manual/en/wrappers.php#wrappers)
